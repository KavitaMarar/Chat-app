...
const Sidebar = () => {
  const {
    getUsers,
    users,
    selectedUser,        // ✅ FIXED (was "selected")
    setSelectedUser,
    unseenMessages,
    setUnseenMessages
      ...
      <div className="pb-5">
        <div className="flex justify-between items-center">
          ...
          <div className="relative py-2 group">
            ...
            />
            <div
              className="absolute top-full right-0 z-20 w-32 p-5 rounded-b-md
        ...
        <div
          className="bg-[#282142] rounded-full flex items-center gap-2 py-3
             px-4 mt-5"
        >
